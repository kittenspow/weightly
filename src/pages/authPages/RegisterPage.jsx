...
const registerSchema = z.object({
    ...
    age: z.string().refine(val => !isNaN(parseInt(val)) && parseInt(val) >= 1 && parseInt(val) <= 120, "Age must be an integer between 1 and 120"),
    gender: z.enum(['male', 'female'], { message: "Gender is required" }),
    height: z.string().refine(val => !isNaN(parseInt(val)) && parseInt(val) >= 50 && parseInt(val) <= 250, "Height must be an integer between 50 and 250 cm"),
